...
- 결과는 `빠른 판단` 또는 `증권사형 장문 보고서`로 출력한다.
...
| 모드 | 트리거 | 기본 산출물 |
| --- | --- | --- |
| 빠른 판단 | 빠른 질문/짧은 판단 요청 | 1페이지 요약 |
| 증권사형 장문 보고서 | `리포트/보고서/PDF/증권사 형식/애널리스트 형식` 요청 | 표지형 1페이지 + 본문 + 결론 + 컴플라이언스 |
...
| 심층 개시 보고서 | "테슬라 심층 리포트 써줘" | 증권사형 장문 보고서 |
| 증권사형 노트 | "증권사 보고서처럼 써줘" | 증권사형 장문 보고서 |
